...
## 1. 개요
Spring REST Docs는 테스트 기반의 API 문서화 도구입니다. 실제 테스트 케이스를 통과한 요청과 응답만을 문서로 생성하므로, 코드와 문서 사이의 불일치를 원천적으로 방지합니다. 본 프로젝트는 **Asciidoctor**를 사용하여 마크업 기반의 정적 문서를 생성합니다.
